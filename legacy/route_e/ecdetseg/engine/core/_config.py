...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        # Preserve the original data-iteration LR clock when physical
        # micro-batch size changes after a checkpoint resume.
        self.lr_schedule_iterations_per_epoch: int = None
        self.scheduler_reference_batch_size: int = None
        ...
        self.query_clip_max_norm : float = 0.1
        self.min_effective_batch_size : int = 16
        self.freeze_backbone_epochs : int = 0
        self.backbone_unfreeze_layers_per_epoch : int = 0
        self.stop_aug_resume_checkpoint : str = None
        self.pareto_metrics :dict = None
        self.evaluation_profile :str = 'full'
        self.inline_eval :bool = True
        self.inline_eval_freq :int = 1
        self.enable_online_pseudo :bool = False
        self.pseudo_score_threshold :float = 0.35
        self.pseudo_quality_threshold :float = 0.30
        self.pseudo_set_iou_threshold :float = 0.50
        self.pseudo_endpoint_threshold :float = 0.15
        self.pseudo_trajectory_iou_threshold :float = 0.30
        self.max_pseudo_instances :int = 256
        self.pseudo_ignore_score_threshold :float = 0.55
        self.log_gradient_conflicts_every :int = 0
        self.find_unused_parameters :bool = None
        self.enable_ddp_no_sync :bool = False
        self.enable_explicit_accumulated_gradient_sync :bool = False
        self.require_equal_domain_updates :bool = False
        self.enable_continuous_stage_training :bool = False
        self.bee_e_initialization :dict = None
        self.bee_e_split_contract :dict = None
        self.bee_e_design_evidence :dict = None
        self.bee_e_input_distribution_evidence :dict = None
        self.bee_e_stage_specs :list = None
        self.bee_e_metric_directions :dict = None
        self.bee_e_official_primary_metric :str = None
        self.bee_e_stage_constraints :dict = None
        self.bee_e_total_coverage_budget :int = None
        self.bee_e_bootstrap_samples :int = 1000
        self.bee_e_minimum_plateau_window :int = 4
        self.bee_e_debt_metrics :dict = None
