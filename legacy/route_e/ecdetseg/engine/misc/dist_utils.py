...
def atomic_save_on_master(state, path, write_ready=False):
    """Save a checkpoint atomically and optionally publish a ready marker."""
...
def warp_loader(loader, shuffle=False):
    if is_dist_available_and_initialized():
        if getattr(loader.sampler, 'is_domain_balanced', False):
            return loader
